...
//
//   ucd-generate property-values ./tables
//
...
pub const PROPERTY_VALUES: &'static [(&'static str, &'static [(&'static str, &'static str)])] = &[
  ...
  ("v121", "V12_1"), ("v130", "V13_0"), ("v140", "V14_0"), ("v20", "V2_0"),
  ...
  ("kanaextb", "Kana_Extended_B"), ("kanaextendeda", "Kana_Extended_A"),
  ("kanaextendedb", "Kana_Extended_B"), ("kanasup", "Kana_Supplement"),
  ...
  ("kayahli", "Kayah_Li"), ("kharoshthi", "Kharoshthi"),
  ...
  ("khojki", "Khojki"), ("khudawadi", "Khudawadi"),
  ("kits", "Khitan_Small_Script"), ("knda", "Kannada"), ("kthi", "Kaithi"),
  ("lana", "Tai_Tham"), ("lao", "Lao"), ("laoo", "Lao"), ("latin", "Latin"),
  ("latn", "Latin"), ("lepc", "Lepcha"), ("lepcha", "Lepcha"),
  ("limb", "Limbu"), ("limbu", "Limbu"), ("lina", "Linear_A"),
  ("linb", "Linear_B"), ("lineara", "Linear_A"), ("linearb", "Linear_B"),
  ("lisu", "Lisu"), ("lyci", "Lycian"), ("lycian", "Lycian"),
  ("lydi", "Lydian"), ("lydian", "Lydian"), ("mahajani", "Mahajani"),
  ("mahj", "Mahajani"), ("maka", "Makasar"), ("makasar", "Makasar"),
  ...
  ("medefaidrin", "Medefaidrin"), ("medf", "Medefaidrin"),
  ...
  ("olduyghur", "Old_Uyghur"), ("oriya", "Oriya"), ("orkh", "Old_Turkic"),
  ("orya", "Oriya"), ("osage", "Osage"), ("osge", "Osage"),
  ("osma", "Osmanya"), ("osmanya", "Osmanya"), ("ougr", "Old_Uyghur"),
  ...
  ("tangsa", "Tangsa"), ("tangut", "Tangut"), ("tavt", "Tai_Viet"),
  ("telu", "Telugu"), ("telugu", "Telugu"), ("tfng", "Tifinagh"),
  ("tglg", "Tagalog"), ("thaa", "Thaana"), ("thaana", "Thaana"),
  ("thai", "Thai"), ("tibetan", "Tibetan"), ("tibt", "Tibetan"),
  ("tifinagh", "Tifinagh"), ("tirh", "Tirhuta"), ("tirhuta", "Tirhuta"),
  ("tnsa", "Tangsa"), ("toto", "Toto"), ("ugar", "Ugaritic"),
  ("ugaritic", "Ugaritic"), ("unknown", "Unknown"), ("vai", "Vai"),
  ("vaii", "Vai"), ("vith", "Vithkuqi"), ("vithkuqi", "Vithkuqi"),
  ("wancho", "Wancho"), ("wara", "Warang_Citi"),
